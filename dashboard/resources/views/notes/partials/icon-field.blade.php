...
<div data-icon-field class="flex items-center gap-2 flex-wrap">
    <input type="text" name="icon" maxlength="16" value="{{ $value }}"
           class="input w-14 text-center text-lg shrink-0" placeholder="—" aria-label="{{ __('notes.icon_label') }}">
    <div class="flex flex-wrap gap-0.5">
        ...
        <button type="button" data-icon-set data-icon-value=""
                class="text-xs px-2 py-1 rounded text-muted hover:bg-ink-100 dark:hover:bg-ink-800">{{ __('notes.icon_none') }}</button>
    </div>
</div>
